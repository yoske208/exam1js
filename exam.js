...
function mission1(unit){
    ...
    return console.log(unit.commandStructure.chiefOfStaff.rank , unit.commandStructure.chiefOfStaff.name , unit.commandStructure.chiefOfStaff.contact.phone);
}
